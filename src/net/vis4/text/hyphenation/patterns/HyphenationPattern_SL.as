...
package net.vis4.text.hyphenation.patterns 
{
	...
	// ask Mojca Miklavec (mojca dot miklavec dot lists at gmail dot com)	public class HyphenationPattern_SL extends HyphenationPattern
	public class HyphenationPattern_SL extends HyphenationPattern
	{
		public function HyphenationPattern_SL() {
			leftmin = 2;
			rightmin = 2;
			shortestPattern = 2;
			longestPattern = 6;
